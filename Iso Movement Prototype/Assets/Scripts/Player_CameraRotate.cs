...
public class Player_CameraRotate : MonoBehaviour
{
    ...
    void Update()
    {
        Resulting_Value_from_Input += Input.GetAxis("Rotate") * Rotation_Speed * Rotation_Friction; //You can also use "Mouse X"
